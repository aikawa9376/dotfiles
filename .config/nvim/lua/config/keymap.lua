...
map("i", "<C-u>", "<C-g>U<C-u>")
map("i", "<C-w>", "<C-g>U<C-w>")
map("i", "<M-f>", "<C-g>U<S-Right>")
map("i", "<M-b>", "<C-g>U<S-Left>")
map("i", "<M-p>", "<C-g>U<C-r>0")
...
map("n", "<Leader>x", "<cmd>lua Snacks.bufdelete.delete()<CR>", { noremap = true, silent = true })
map("n", "<Leader>X", "<cmd>lua Snacks.bufdelete.other()<CR>", { noremap = true, silent = true })
map("n", "<Leader>z", "<cmd>lua Snacks.bufdelete.all()<CR>")
