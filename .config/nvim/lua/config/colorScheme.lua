...
local function apply_colorscheme()
  ...
  set_highlight("WinBar", { fg = "#acadae", bg = "#00222b" })
  set_highlight("WinBarNC", { fg = "#839496", bg = "#002b36" })
  set_highlight("Comment", { italic = true, fg = "#586e75" })
  set_highlight("GitStatusCommitSubject", { fg = "#586e75" })
  set_highlight("GitStatusFolded", { fg = "#839496", bg = "NONE" })
  set_highlight("QuickFixLine", { bg = "#20436e", bold = true })
  ...
  set_highlight("@markup.strong", { fg = "#98c379", bg = "NONE", bold = true })
  ...
  set_highlight("Delimiter", { fg = "#586e75" })
  ...
  set_highlight("MCursor", { fg = "#002b36", bg = "#5fffff", bold = true })
  set_highlight("MCursorVisual", { bg = "#20436e", underline = true, special = "#5fffff" })
  ...
  set_highlight("FugitiveStatAdd", { fg = "#768e6e" })
  set_highlight("FugitiveStatDelete", { fg = "#98676f" })
  set_highlight("GitSignsChangeDelete", { fg = "#ec5f67", bg = "NONE" })
  set_highlight("GitSignsCurrentLineBlame", {  fg = "#81a1c1"  })
  set_highlight("GitSignsDeletePreview", { fg="#586e75" })
  ...
  set_highlight("DiffDelete", { fg = "#41788c", bg = "NONE" })
  set_highlight("DiffAdd", { fg = "NONE", bg = "#23384C" })
  set_highlight("DiffChange", { fg = "NONE", bg = "#33406B" })
  set_highlight("DiffText", { fg = "#CFC8B8", bg = "#005f5f" })
  set_highlight("ConflictIncoming", { fg = "NONE", bg = "#094b5c" })
  set_highlight("ConflictCurrent", { fg = "NONE", bg = "#23384C" })
  set_highlight("DiffviewDiffDelete", { fg = "#41788c", bg = "NONE" })
  ...
  set_highlight("FidgetTask", { fg = "#586e75", bg = "NONE"  })
  ...
  set_highlight("NoiceCmdlinePopup", { bg = "#002b36" })
  set_highlight("NoiceMini", { bg = "#002b36" })
  set_highlight("NoiceFormatProgressTodo", { bg = "#002b36" })
  set_highlight("NoiceLspProgressTitle", { fg = "#586e75" })
  set_highlight("NoiceLspProgressSpinner", { fg = "#98be65" })
  ...
  set_highlight("AvanteSidebarNormal", { fg = "#acadae" })
