vim.g.git_graph_backend = 'native' -- This lifecycle test isolates the built-in graph.
...
local shared = table.concat(require('git.features.commit_info').header(root, second), '\n')
