...
local probe = require('git.features.status_probe').new('/tmp', function() changes = changes + 1 end)
...
assert(changes == 0)
probe = require('git.features.status_probe').new('/tmp', function() changes = changes + 1 end)
