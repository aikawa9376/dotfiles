...
local cancel = require('git.features.worktree_watch').subscribe(root, function() end)
...
for _ = 1, 20 do
  cancel = require('git.features.worktree_watch').subscribe(root, function() error('late callback') end)
  cancel(); cancel()
end
