...
function M.setup(deps)
  ...
  local function build_acp_split_opts(agent_name, agent_cfg, launch_spec, split_opts, runtime_key)
    ...
    return {
      ...
      protocol_log = acp.protocol_log,
      show_context_notes = acp.show_context_notes,
      show_session_summary = acp.show_session_summary,
      show_thread_title = acp.show_thread_title,
    ...
    split_opts = {
      on_split = function(pane_id)
        ...
        state.sessions[agent_name] = {
          ...
          show_session_summary = resolved_acp.show_session_summary,
          show_thread_title = resolved_acp.show_thread_title,
