...
- 同梱の`obsidian` skillはSteph Angoの`kepano/obsidian-skills`を仕様上流としてMarkdown・Bases・Canvas・CLI・Defuddleを扱い、`obsidian-memory` skillは重要task前後の耐久知識だけをVaultから検索・更新します。
