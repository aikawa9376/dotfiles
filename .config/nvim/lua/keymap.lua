...
map('n', '<M-h>', 'hx')
map('n', '<M-j>', 'j<cmd>call cursor(0,strlen(getline("."))/2)<CR>', { noremap = true, silent = true })
map('n', '<M-k>', 'k<cmd>call cursor(0,strlen(getline("."))/2)<CR>', { noremap = true, silent = true })
map('n', ']n', 'ngn<ESC>')
map('n', '[n', 'Ngn<ESC>')
map('n', 'gj', 'J')
...
map('n', 'ZZ', '<cmd>call TermForceCloseAll()<CR><cmd>xa<CR>', { noremap = true, silent = true })
